...
import SaraRobot.modules.sql.welcome_sql as sql
from SaraRobot.modules.sql.global_bans_sql import is_user_gbanned
from SaraRobot import dispatcher, OWNER_ID, DEV_USERS, SUDO_USERS, SUPPORT_USERS, TIGER_USERS, WHITELIST_USERS, LOGGER
from SaraRobot.modules.helper_funcs.chat_status import user_admin, is_user_ban_protected
from SaraRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from SaraRobot.modules.helper_funcs.msg_types import get_welcome_type
from SaraRobot.modules.helper_funcs.string_handling import (markdown_parser,
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text("Whoa! A member of the Sara Association just joined!", reply_to_message_id=reply)
